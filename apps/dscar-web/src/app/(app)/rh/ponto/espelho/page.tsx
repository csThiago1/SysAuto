    ...
    <ErrorBoundary>
      <div className="space-y-5">
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <span>/</span>
          <span className="text-foreground">Espelho de ponto</span>
        </div>
        ...
        <div className="rounded-md bg-muted/50 shadow-card overflow-hidden">
          <div className="px-card-padding py-3 border-b border-border flex items-center justify-between">
  ...
  return (
    <div className="flex items-center gap-4 px-card-padding py-3">
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-muted-foreground">{positionDisplay}</p>
      </div>
