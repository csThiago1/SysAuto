  ...
  return (
    <div className="py-6 space-y-5 max-w-2xl mx-auto">
      ...
      <div className="bg-white border border-neutral-200 rounded-lg shadow-sm p-4 space-y-3">
        <label htmlFor="reminder-text" className="text-sm font-semibold text-neutral-700">
          Novo lembrete
        </label>
        <Textarea
          id="reminder-text"
        ...
        <div className="flex items-center justify-between">
          <span className="text-xs text-neutral-400">Ctrl+Enter para salvar</span>
          <Button
            size="sm"
      ...
      <div className="bg-white border border-neutral-200 rounded-lg shadow-sm overflow-hidden">
        <div className="flex items-center gap-2 px-5 py-3 border-b border-neutral-100 bg-neutral-50">
          ...
          <h2 className="text-xs font-semibold uppercase tracking-wide text-neutral-600">
            Lembretes
            {reminders.length > 0 && (
              <span className="ml-2 rounded-full bg-neutral-200 px-1.5 py-0.5 text-xs font-medium text-neutral-700">
                {reminders.length}
              </span>
            )}
          </h2>
            ...
            {reminders.map((r) => (
              <li key={r.id} className="px-5 py-4 flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm text-neutral-800 whitespace-pre-wrap">{r.description}</p>
