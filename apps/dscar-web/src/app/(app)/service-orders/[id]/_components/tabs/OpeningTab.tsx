...
import type { CustomerUpdateInput, PersonPatch } from "../../_hooks/useCustomerSearch"
...
export function OpeningTab({ form, order, onCustomerDataChange, onPersonDataChange }: OpeningTabProps) {
    ...
    <div className="space-y-3 py-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="space-y-3">
          <CustomerSection form={form} onCustomerDataChange={onCustomerDataChange} onPersonDataChange={onPersonDataChange} />
