    ...
    <div className="p-6">
      ...
      <div className="mb-5 grid grid-cols-4 gap-3">
        ...
        <div className="rounded-lg bg-surface-800 p-3">
          ...
          <div className="text-xl font-bold text-foreground">R$ {fmtMoney(totals_diff.old_total)}</div>
        </div>
        <div className="rounded-lg bg-surface-800 p-3">
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-surface-800">
              ...
              <th className="px-3 py-2 text-right font-semibold text-foreground/60">Anterior</th>
              <th className="px-3 py-2 text-right font-semibold text-foreground/60">Novo</th>
              <th className="px-3 py-2 text-center font-semibold text-foreground/60">Alteração</th>
            </tr>
          </thead>
          <tbody>
      ...
      <div className="flex justify-end gap-2">
        <button type="button" onClick={onCancel}
          className="rounded-md border border-border px-4 py-2 text-sm text-foreground/70 hover:bg-muted/50">
          Cancelar
        </button>
        <button type="button" disabled={isApplying} onClick={onApply}
          className="inline-flex items-center gap-2 rounded-md bg-info-600 px-4 py-2 text-sm font-semibold text-foreground hover:bg-info-700 disabled:opacity-50">
