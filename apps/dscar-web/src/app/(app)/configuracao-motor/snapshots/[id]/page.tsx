...
export default function SnapshotDetailPage() {
  ...
  if (isLoading) {
    return (
      <div className="px-0 py-3 md:p-6 text-xs text-muted-foreground">Carregando snapshot…</div>
    )
  }

  if (!snap) {
    return (
      <div className="px-0 py-3 md:p-6 text-xs text-error-400">Snapshot não encontrado.</div>
    )
  }
  ...
  return (
    <div className="px-0 py-3 md:p-6 space-y-6 max-w-3xl">
