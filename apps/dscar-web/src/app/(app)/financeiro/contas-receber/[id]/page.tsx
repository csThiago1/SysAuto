      ...
      <div className="flex-1 min-w-0">
        ...
        <p
          className={`text-lg font-bold mt-0.5 ${
            highlight ? "text-success-700" : "text-neutral-900"
          }`}
        >
          {value}
        </p>
...
function PageSkeleton(): React.ReactElement {
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-md bg-white shadow-card p-5 space-y-3">
      ...
      <div className="space-y-5">
        ...
        <div className="rounded-md bg-white shadow-card p-5">
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            <div className="space-y-1 min-w-0">
              ...
              {doc.notes && (
                <p className="text-xs text-neutral-400 pt-1">{doc.notes}</p>
              )}
            </div>
            ...
            <div className="flex items-center gap-2 shrink-0">
              {canReceive && (
                <button
                  ...
                  className="rounded-md bg-success-600 px-4 py-2 text-sm font-medium text-white hover:bg-success-700 transition-colors"
                >
          ...
          {doc.cancelled_at && (
            <div className="mt-3 rounded-md bg-neutral-50 border border-neutral-200 px-4 py-2.5 text-xs text-neutral-600">
        ...
        <div className="rounded-md bg-white shadow-card overflow-hidden">
          ...
          {doc.receipts.length === 0 ? (
            ...
            <>
              {/* Table header */}
              <div className="hidden md:grid grid-cols-[1fr_1fr_1.5fr_2fr] gap-4 px-5 py-2.5 bg-neutral-50 border-b border-neutral-100 text-xs font-semibold text-neutral-500 uppercase tracking-wide">
                <span>Data</span>
                ...
                {doc.receipts.map((receipt) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="text-neutral-600">{methodLabel}</span>
