...
export default function OrcamentoDetailPage() {
  ...
  if (isLoading) return <div className="px-0 py-3 md:p-6 text-muted-foreground text-sm">Carregando orçamento...</div>
  if (error || !orc) return <div className="px-0 py-3 md:p-6 text-error-400 text-sm">Orçamento não encontrado.</div>
