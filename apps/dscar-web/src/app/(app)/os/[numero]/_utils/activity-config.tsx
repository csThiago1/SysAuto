...
export const ACTIVITY_CONFIG: Partial<Record<ActivityType, ActivityConfig>> = {
  ...
  updated: {
    icon: <Edit3 className="h-4 w-4 text-warning-400" />,
    ringClass: "ring-warning-500/20",
    bgClass: "bg-warning-500/10",
    label: "Atualização",
  },
  customer_updated: {
    icon: <UserCheck className="h-4 w-4 text-info-400" />,
    ringClass: "ring-info-500/20",
    bgClass: "bg-info-500/10",
    label: "Cliente",
  },
  vehicle_updated: {
    icon: <Car className="h-4 w-4 text-info-400" />,
    ringClass: "ring-info-500/20",
    bgClass: "bg-info-500/10",
    label: "Veículo",
  },
  schedule_updated: {
    icon: <Calendar className="h-4 w-4 text-warning-400" />,
    ringClass: "ring-warning-500/20",
    bgClass: "bg-warning-500/10",
    label: "Datas/Prazo",
  },
  insurer_updated: {
    icon: <Shield className="h-4 w-4 text-warning-400" />,
    ringClass: "ring-warning-500/20",
    bgClass: "bg-warning-500/10",
    label: "Seguradora",
  },
  ...
  file_upload: {
    icon: <Paperclip className="h-4 w-4 text-info-400" />,
    ringClass: "ring-info-500/20",
    bgClass: "bg-info-500/10",
    label: "Foto",
  },
  ...
  cilia_import: {
    icon: <Download className="h-4 w-4 text-info-400" />,
    ringClass: "ring-info-500/20",
    bgClass: "bg-info-500/10",
  ...
  labor_added: {
    icon: <Wrench className="h-4 w-4 text-warning-400" />,
    ringClass: "ring-warning-500/20",
    bgClass: "bg-warning-500/10",
    label: "Serviço",
  },
