    ...
    <div className="space-y-2">
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        <div>
          ...
          <NativeSelect {...register("vehicle_location")} aria-invalid={!!errors.vehicle_location}>
        ...
        <div className="rounded-lg border border-border bg-muted/30 p-3 space-y-2">
          ...
          {order.nfe_key && (
            <div className="space-y-0.5">
              ...
              <p className={cn("text-xs font-mono text-foreground/90 break-all bg-muted/50 rounded px-2 py-1", order.nfe_key.replace(/\D/g, "").length !== 44 && "text-amber-700 bg-amber-50")}>
                {order.nfe_key}
              </p>
          ...
          {order.nfse_number && (
            <div className="space-y-0.5">
              ...
              <p className="text-xs font-mono text-foreground/90 bg-muted/50 rounded px-2 py-1">
                {order.nfse_number}
              </p>
            </div>
          )}
