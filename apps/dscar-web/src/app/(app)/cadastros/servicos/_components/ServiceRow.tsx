...
export function ServiceRow({ item, onEdit }: Props) {
  ...
  return (
    <>
      <div className="flex items-center gap-3 px-4 py-3 group hover:bg-neutral-50 transition-colors">
        {/* Nome + descrição */}
        ...
        {/* Preço */}
        <span className="text-sm font-mono text-neutral-700 tabular-nums shrink-0">
          {price}
        </span>
