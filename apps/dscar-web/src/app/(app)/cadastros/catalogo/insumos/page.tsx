...
export default function InsumosPage() {
  ...
  return (
    <div className="flex flex-col gap-6 p-6 max-w-5xl mx-auto">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-neutral-900">Insumos / Materiais</h1>
            ...
            <TableBody>
              {insumos.map((i: InsumoMaterial) => (
                <TableRow key={i.id}>
                  ...
                  <TableCell className="py-2 font-medium text-neutral-800">{i.descricao}</TableCell>
                  <TableCell className="py-2 text-sm text-neutral-600">{i.marca || "—"}</TableCell>
                  <TableCell className="py-2 font-mono text-xs text-neutral-600">
                    {i.gtin || "—"}
                  </TableCell>
      ...
      <p className="text-xs text-neutral-400">{insumos.length} insumos carregados.</p>
    </div>
  )
}
