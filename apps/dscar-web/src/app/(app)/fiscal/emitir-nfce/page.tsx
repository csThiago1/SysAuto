...
export default function EmitirNfcePage() {
  ...
  if (!canEmit) {
    return <div className="px-0 py-3 md:p-6 text-muted-foreground">Sem permissão para emitir NFC-e.</div>
  }

  if (result) {
    return (
      <div className="px-0 py-3 md:p-6 max-w-2xl mx-auto space-y-6">
  ...
  return (
    <div className="px-0 py-3 md:p-6 max-w-3xl mx-auto space-y-6">
