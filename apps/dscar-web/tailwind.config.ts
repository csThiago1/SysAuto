  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // CATEGORICAL — Purple (5ª cor de categoria)
        // Status de aprovação/especiais (OC pendente, aguardando aprovação,
        // OWNER, ferramenta, recondicionada). Pinado aqui para ser temável;
        // não usar para novos semânticos — preferir success/warning/error/info.
        purple: {
          "50":  "#faf5ff",
          "100": "#f3e8ff",
          "200": "#e9d5ff",
