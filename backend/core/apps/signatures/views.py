...
class SignatureViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    filterset_fields = ["service_order", "budget", "document_type", "method"]
    ...
    def capture(self, request):
        ...
        Body JSON:
          {
            ...
            "service_order_id": 42,  // ou budget_id
        ...
        if ser.validated_data.get("budget_id"):
            budget = get_object_or_404(Budget, pk=ser.validated_data["budget_id"])
